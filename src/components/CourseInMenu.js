...
const CourseInMenu = ({ course, setCourseRedirectID, setShowLikedCourses, setCourseCategory }) => {
    ...
    const getStars = (rate) => {
        if (rate === 0) {
            ...
            return (<IconContext.Provider value={{ color: "yellow" }}>
                <FaStar />
                <FaRegStar />
                <FaRegStar />
                <FaRegStar />
    ...
    return (
        <>
            <div className="menu__course" onClick={redirect}>
                <img className="menu__image" alt="noo" src={course.image ? `http://localhost:8080/courses/${course.id}/img` : "/assets/react_js.jpg"} width="290px" height="160px" />
                    ...
                    <div className="menu__course-price">
                        <i>{course.promotion ?
                            <>
                                {course.promotion}$
                                <br></br>
                                <strike style={{ "fontSize": "20px", "color": "yellow" }}>{course.price}$</strike>
                            </>
                            :
                            course.price + "$"}
                        </i>
